(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,52683,a=>{"use strict";var e=a.i(43476),t=a.i(71645);function i(){let a=(0,t.useRef)(null),i=(0,t.useRef)(!1);return(0,t.useEffect)(()=>{if(i.current||!a.current)return;i.current=!0;let e=document.createElement("style");e.setAttribute("data-v11","true"),e.textContent=`
...
`,document.head.appendChild(e),document.querySelectorAll("[data-layout-chrome]").forEach(a=>{a.style.display="none"});let t=document.querySelector("main");t&&(t.style.overflow="hidden"),a.current.innerHTML=`<div class="shell">
  <!-- TOP BAR + BTC -->
  ...
  <div class="main">
    ...
    <div class="glass glass-elevated panel" data-href="/937-mission-control/clients">
      ...
      <div class="client-list">
        <div class="client-item"><div class="cl-logo"><svg viewBox="0 0 24 24" fill="none"><polygon points="12,2 22,8 22,16 12,22 2,16 2,8" stroke="#D22028" stroke-width="1.5"/><circle cx="12" cy="12" r="3" stroke="#DF656E" stroke-width="1.2"/></svg></div><div class="cl-info"><div class="cl-name">Nexus Protocol</div><div class="cl-type">DeFi \xb7 Token Launch</div><div class="cl-service">Brand Identity & Token Launch Design</div></div><div class="cl-right"><div class="cl-status active">Active</div><div class="cl-value">$18K</div></div></div>
        <div class="client-item"><div class="cl-logo"><svg viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="8" stroke="#D22028" stroke-width="1.5"/><ellipse cx="12" cy="12" rx="3" ry="8" stroke="#DF656E" stroke-width="1"/></svg></div><div class="cl-info"><div class="cl-name">Orbital Labs</div><div class="cl-type">AI Infra \xb7 Series A</div><div class="cl-service">Website Design & UI/UX</div></div><div class="cl-right"><div class="cl-status active">Active</div><div class="cl-value">$22K</div></div></div>
        <div class="client-item"><div class="cl-logo"><svg viewBox="0 0 24 24" fill="none"><rect x="4" y="4" width="16" height="16" rx="2" stroke="#D22028" stroke-width="1.5"/><path d="M4 12h16" stroke="#DF656E" stroke-width="1"/><path d="M12 4v16" stroke="#DF656E" stroke-width="1"/></svg></div><div class="cl-info"><div class="cl-name">Vanta Finance</div><div class="cl-type">Fintech \xb7 B2B</div><div class="cl-service">Product Design & Dark Mode</div></div><div class="cl-right"><div class="cl-status active">Active</div><div class="cl-value">$15K</div></div></div>
        <div class="client-item"><div class="cl-logo"><svg viewBox="0 0 24 24" fill="none"><path d="M12 2L2 7v10l10 5 10-5V7z" stroke="#D22028" stroke-width="1.5"/><path d="M12 12V22" stroke="#DF656E" stroke-width="1"/><path d="M2 7l10 5 10-5" stroke="#DF656E" stroke-width="1"/></svg></div><div class="cl-info"><div class="cl-name">ChainMind</div><div class="cl-type">AI \xd7 Crypto</div><div class="cl-service">Pitch Deck & Brand Strategy</div></div><div class="cl-right"><div class="cl-status active">Review</div><div class="cl-value">$8K</div></div></div>
        <div class="client-item"><div class="cl-logo"><svg viewBox="0 0 24 24" fill="none"><path d="M2 20L12 4l10 16z" stroke="#D22028" stroke-width="1.5"/><line x1="7" y1="14" x2="17" y2="14" stroke="#DF656E" stroke-width="1"/></svg></div><div class="cl-info"><div class="cl-name">Strata</div><div class="cl-type">L2 \xb7 Mainnet</div><div class="cl-service">Motion Design & Storyboards</div></div><div class="cl-right"><div class="cl-status active">Active</div><div class="cl-value">$12K</div></div></div>
      </div>
    </div>
    ...
    <div class="glass glass-elevated panel" data-href="/937-mission-control/leads">
      ...
      <div class="lead-list">
        <div class="lead-item"><div class="ld-dot hot"></div><div class="ld-info"><div class="ld-name">Meridian DAO</div><div class="ld-src">Referral \xb7 Call scheduled</div></div><div class="ld-val">$15K</div></div>
        <div class="lead-item"><div class="ld-dot hot"></div><div class="ld-info"><div class="ld-name">Flux AI</div><div class="ld-src">Twitter DM \xb7 Brand kit</div></div><div class="ld-val">$12K</div></div>
        <div class="lead-item"><div class="ld-dot warm"></div><div class="ld-info"><div class="ld-name">Zenith Labs</div><div class="ld-src">Inbound \xb7 Website inquiry</div></div><div class="ld-val">$8K</div></div>
        <div class="lead-item"><div class="ld-dot warm"></div><div class="ld-info"><div class="ld-name">Prism Network</div><div class="ld-src">Conference \xb7 Follow-up</div></div><div class="ld-val">$20K</div></div>
    ...
    <div class="glass glass-elevated panel" data-href="/937-mission-control/content-calendar">
      ...
      <div class="content-list">
        <div class="content-item"><div class="ci-type"><svg viewBox="0 0 24 24"><path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5 0-.278-.028-.556-.08-.83A7.72 7.72 0 0023 3z"/></svg></div><div class="ci-info"><div class="ci-title">Vanta case study</div><div class="ci-meta">X \xb7 8 posts</div></div><div class="ci-status scheduled">Scheduled</div></div>
        <div class="content-item"><div class="ci-type"><svg viewBox="0 0 24 24"><rect x="2" y="2" width="20" height="20" rx="5"/><path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg></div><div class="ci-info"><div class="ci-title">Nexus brand reel</div><div class="ci-meta">Instagram \xb7 Video</div></div><div class="ci-status">Draft</div></div>
        <div class="content-item"><div class="ci-type"><svg viewBox="0 0 24 24"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22 6 12 13 2 6"/></svg></div><div class="ci-info"><div class="ci-title">March newsletter</div><div class="ci-meta">Email \xb7 2.4K subs</div></div><div class="ci-status">Draft</div></div>
        <div class="content-item"><div class="ci-type"><svg viewBox="0 0 24 24"><path d="M2 3h6a4 4 0 014 4v14a3 3 0 00-3-3H2z"/><path d="M22 3h-6a4 4 0 00-4 4v14a3 3 0 013-3h7z"/></svg></div><div class="ci-info"><div class="ci-title">Design process blog</div><div class="ci-meta">Blog \xb7 Long-form</div></div><div class="ci-status scheduled">Mar 7</div></div>
      </div>
    </div>
  </div>
...
</div>`;let s=document.createElement("script");return s.textContent=`// MULTI-ASSET TICKER — cycles through BTC, ETH, SOL, Gold, Silver with real prices
const assets = [
...
const modalConfig = {
  ...
  client: { title: 'New Client', fields: [
    ...
    {name:'industry',label:'Industry',type:'text',placeholder:'e.g. DeFi \xb7 Token Launch'},
...
});`,document.body.appendChild(s),()=>{let a=document.querySelector("style[data-v11]");a&&a.remove(),document.querySelectorAll("[data-layout-chrome]").forEach(a=>{a.style.display=""}),t&&(t.style.overflow="")}},[]),(0,e.jsx)("div",{ref:a})}a.s(["default",()=>i])}]);